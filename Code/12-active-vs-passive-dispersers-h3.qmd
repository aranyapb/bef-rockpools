...
p1 <- 
  ...
  guides(size = "none", colour = guide_legend(override.aes = list(size = 2.5, alpha = 1, shape =    1, stroke = 1),nrow = 1)) +
...
# Load the plots
fig7a <- readRDS(here("Figures/fig_7a.rds"))
fig7b <- readRDS(here("Figures/fig_7b.rds"))

# Optional: remove legend background
fig7a <- fig7a + theme(legend.key = element_blank())
fig7b <- fig7b + theme(legend.key = element_blank())
