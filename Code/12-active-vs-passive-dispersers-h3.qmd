...
In addition, we expected that there would be no effect of log-transformed prominence in passive dispersers. This was supported as there was no evidence for an effect of log-transformed prominence in passive dispersers (P = 0.46). *ARANYA NOTE: p=0.16 - similar result to Active dispersers... but Rsq is better in AD*
