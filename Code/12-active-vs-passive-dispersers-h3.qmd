...
Under our hypothesis, we expect that the effect of log-transformed prominence will be significantly negative in active dispersers. In this model, the effect of log-transformed prominence is negative and marginally significant (P = 0.06). *ARANYA NOTE: p=0.1* 
